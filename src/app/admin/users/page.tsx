      ...
      <main className="flex min-h-screen items-center justify-center bg-transparent px-4">
        <div className="w-full max-w-sm">
          <div className="mb-8 flex flex-col items-center gap-3 text-center">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-white/20 to-white/10 text-sm font-bold text-white ">
              S
            </div>
            <div>
              <p className="text-lg font-semibold text-[var(--color-text)]">Admin Access</p>
              <p className="mt-1 text-sm text-[var(--color-text-hint)]">Enter the admin secret to continue</p>
            </div>
          </div>
          ...
          <form action={authenticateAdmin} className="space-y-4">
            <input
              ...
              className="w-full rounded-2xl border border-white/10 glass px-4 py-3 text-sm text-[var(--color-text)] outline-none transition placeholder:text-[var(--color-text-hint)] focus:border-white/30"
            />
            {hasError ? (
              <p className="rounded-xl bg-error/[0.07] px-4 py-2.5 text-sm text-error">
  ...
  return (
    <main className="min-h-screen bg-transparent px-4 py-12">
      <div className="mx-auto max-w-xl">
        {/* Header */}
        <div className="mb-8">
          <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-br from-white/20 to-white/10 text-xs font-bold text-white ">
            S
          </div>
          <h1 className="mt-4 font-display text-2xl font-semibold text-[var(--color-text)]">User Management</h1>
          <p className="mt-1 text-sm text-[var(--color-text-hint)]">Search for an account and delete all associated data.</p>
        </div>
